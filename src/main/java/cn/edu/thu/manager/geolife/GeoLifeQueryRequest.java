...
import indexingTopology.api.client.IClientRequest;
 ...
 */
public class GeoLifeQueryRequest<T extends Number>  extends IClientRequest {
    final public T x1;
    final public T x2;
    final public T y1;
    final public T y2;
    ...
    public GeoLifeQueryRequest(T x1, T x2, T y1, T y2, long startTime, long endTime, DataTuplePredicate predicate, DataTuplePredicate postPredicate,
    ...
    public GeoLifeQueryRequest(T x1, T x2, T y1, T y2, long startTime, long endTime, DataTuplePredicate predicate,
    ...
    public GeoLifeQueryRequest(T x1, T x2, T y1, T y2, long startTime, long endTime, Aggregator aggregator) {
    ...
    public GeoLifeQueryRequest(T x1, T x2, T y1, T y2, long startTime, long endTime) {
